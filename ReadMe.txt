========================================================================
		ActiveX Control DLL : KCOMCHART
========================================================================

ControlWizard has created this project for your KCOMCHART ActiveX Control
...
that make up your KCOMCHART ActiveX Control DLL.
...
KCOMChartCtl.h
	This file contains the declaration of the CKCOMChartCtrl C++ class.

KCOMChartCtl.cpp
	This file contains the implementation of the CKCOMChartCtrl C++ class.

KCOMChartPpg.h
	This file contains the declaration of the CKCOMChartPropPage C++ class.

KCOMChartPpg.cpp
	This file contains the implementation of the CKCOMChartPropPage C++ class.

KCOMChartCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CKCOMChartCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file KCOMChart.rc.
